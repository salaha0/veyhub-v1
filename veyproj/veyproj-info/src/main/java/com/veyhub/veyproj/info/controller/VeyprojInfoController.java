package com.veyhub.veyproj.info.controller;
...
import com.elevoc.sdk.idgenerator.ElevocIdGenerator;
import com.veyhub.veyproj.info.domain.entity.VeyprojInfo;
import com.veyhub.veyproj.info.domain.service.VeyprojInfoService;
import com.veyhub.veyproj.info.domain.vo.VeyprojInfoVO;
...
public class VeyprojInfoController {
    ...
    public ResponseEntity<VeyprojInfo> add(@RequestBody VeyprojInfoVO veyprojInfoVO) {
        ...
        veyprojInfo.setNumber(ElevocIdGenerator.uuid32());
        try {
